...
namespace ThanhToanPXB
{
    public class ThanhToanPXB:ICReport
    {
        ...
        private void UpdateDaTT()
        {
            ...
            string sql = "UPDATE MT33 SET DaTT = 1 WHERE MT33ID IN ({0});";// update MT33
            string dk = "";
            foreach (DataRowView drv in dv)
            {
                dk += string.Format("'{0}',", drv.Row["MT33ID"]);
                drv.Row.Delete();
            }
